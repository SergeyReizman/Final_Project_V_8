// Importing assets for social media icons and client logos
import {
  people01,
  people02,
  people03,
...
// Features section with icon, title, and content
...
// Feedback/Testimonials section with user feedback, name, title, and image
...
// Statistics section with title and value
export const stats = [
...
// Footer links categorized under Useful Links, Community, and Partner
...
// Social media icons with id, icon, and link
export const socialMedia = [
  ...
  { id: "social-media-4", icon: linkedin, link: "https://www.linkedin.com/in/sergey-reizman//" },
];

// Client logos with id and logo
